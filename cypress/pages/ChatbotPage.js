...
class KatBotPage {
  constructor() {
    ...
    this.iframeSelector = 'iframe'; // Selector general del iframe del bot
    this.inputSelector = 'input[name="message"]';
    this.sendButtonSelector = 'button[type="submit"], button.send';
    this.botNameSelector = '.bot-name, .chat-header'; // Ajusta según el header del bot
    this.responseSelector = '.message, .chat-message'; // Ajusta según la clase de los mensajes
  }
